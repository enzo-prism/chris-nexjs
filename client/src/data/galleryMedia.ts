...
export const galleryItems: readonly GalleryMediaItem[] = [
  // --- OUR SPACE ---
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989225/Post-2_hdbi3u.webp",
  ...
  },
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989225/Post-5_dib4rp.webp",
  ...
  {
    id: "photo-quiet-garden-courtyard",
    kind: "image",
    src: "/images/office/quiet-garden-courtyard.webp",
    alt: "Quiet garden courtyard outside the Palo Alto dental treatment rooms",
    title: "A Quiet Garden View",
    description: "A closer look at the planted courtyard that brings calm natural light into the office.",
    category: "Our Space",
    layout: "photoStandard",
    interaction: "staticImage",
  },
  {
    id: "photo-courtyard-treatment-suite",
    kind: "image",
    src: "/images/office/courtyard-treatment-suite.webp",
    alt: "Dental treatment suite beside the office garden courtyard",
    title: "Care With Natural Light",
    description: "Treatment rooms look onto the courtyard so visits feel brighter, calmer, and more open.",
    category: "Our Space",
    layout: "photoStandard",
    interaction: "staticImage",
  },
  {
    id: "photo-garden-view-operatory",
    kind: "image",
    src: "/images/office/garden-view-operatory.webp",
    alt: "Garden-view operatory at Christopher B. Wong DDS in Palo Alto",
    title: "Garden-View Operatories",
    description: "Real office views show how the practice pairs modern care with a relaxed environment.",
  ...
  },
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989225/Post_e0ayi2.webp",
  ...
  // --- PATIENT CARE ---
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989226/Post-7_d8rmrk.webp",
  ...
  },
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989226/Post-8_jmfidt.webp",
  ...
  },
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989226/Post-6_uhnnyg.webp",
  ...
  },
  {
    ...
    kind: "image",
    src: "https://res.cloudinary.com/dhqpqfw6w/image/upload/v1762989227/Polaroids_iep3fj.webp",
